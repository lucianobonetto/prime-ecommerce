...
import ProductCard from './ProductCard'; // <-- ¡MAGIA! Importamos nuestra tarjeta oficial
        ...
        {products.length > 0 ? (
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-10">
            {products.map((producto) => (
              // Reemplazamos las 40 líneas de código viejo por nuestro componente reutilizable
